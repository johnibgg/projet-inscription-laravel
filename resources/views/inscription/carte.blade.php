...
<div class="card bg-white rounded-xl shadow-lg max-w-md mx-auto mt-8 p-6 text-sm">
  ...
  <div class="flex justify-between items-center mb-6">
    ...
    <img src="{{ asset('storage/' . ($inscription->eleve->photo ?? 'default.png')) }}" class="h-20 w-16 object-cover border rounded" alt="Photo">
  </div>
  ...
  <div class="mt-6 text-center text-xs text-gray-500 border-t pt-4">
    ...
    Adresse : Calavie, Bénin — Tél : +229 01 51 46 45 10
  </div>
