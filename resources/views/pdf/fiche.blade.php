...
<div class="max-w-4xl mx-auto bg-white p-6 rounded-xl shadow-lg">
  ...
  <div class="grid md:grid-cols-2 gap-4 mb-4">
    ...
    <input type="text" value="{{ \Carbon\Carbon::parse($inscription->eleve->date_naissance)->format('d/m/Y') }}" readonly>
...
<div class="grid md:grid-cols-2 gap-4 mb-4">
  <div><label>Nom du parent :</label><input type="text" value="{{ $inscription->eleve->parentTuteur->nom }}" readonly></div>
  <div><label>Téléphone :</label><input type="text" value="{{ $inscription->eleve->parentTuteur->telephone }}" readonly></div>
  <div class="md:col-span-2"><label>Adresse email :</label><input type="text" value="{{ $inscription->eleve->parentTuteur->email }}" readonly></div>
</div>
  ...
  <p class="text-center text-xs text-gray-400 mt-8 italic">Document généré automatiquement – Plateforme d’inscription scolaire</p>
</div>
@endsection
