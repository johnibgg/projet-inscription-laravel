...
<body>
  ...
  <header class="header">
    <div class="container header-content">
      <h1 class="header-title">👧 Gestion des Élèves</h1>
  ...
  <main class="container">
    ...
    <div class="search-bar">
      <h2 class="section-title">Liste des élèves inscrits</h2>
      <input type="text" placeholder="🔍 Rechercher un élève..." class="search-input" />
    </div>
    ...
    <div class="table-container">
      <table>
        ...
        <tbody>
          ...
          <!-- Autres élèves ici dynamiquement -->
        </tbody>
      </table>
    </div>
  </main>
